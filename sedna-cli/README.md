...
./gradlew :sedna-cli:run --args="validate --input=examples/cms-reference-fixture.sdna"
./gradlew :sedna-cli:run --args="diff --left=a.sdna --right=b.sdna --format=json"
./gradlew :sedna-cli:run --args="visualize --input=examples/cms-reference-fixture.sdna --output=/tmp/cms.dot"
./gradlew :sedna-cli:run --args="run --input=examples/cms-reference-fixture.sdna --checkpoint-dir=/tmp/cp"
